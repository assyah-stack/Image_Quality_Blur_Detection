...
1. Set up the project and Loaded the Data 
3. Explored Images in the Data 
4. Trainined an Initial Convolutional Layer 
5. Looked at the Model Error 
6. Improved the Model Accuracy 
7. Augmented the Data 
8. Investigated the Model Error
